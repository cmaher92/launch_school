...
def fun_with_ids
  ...
  # this will fail because you don't have access to local variables initialized within a method, once the method ends execution variables
  # defined within the method are no longer available to access. 
