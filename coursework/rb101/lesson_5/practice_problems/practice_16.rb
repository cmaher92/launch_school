...
# and is typically broken into 5 sections like this 8-4-4-4-12 and
...
# Create a 8-4-4-4-12 series of hex numbers
# totalling 32 characters
# Generate an array of 32 items, each a random number between 1-16
arr = Array.new(32) { rand(1..16).to_s(16) }
# Add '-' at index 8, 12, 16, 20, -1
arr.insert(8, '-')
arr.insert(12, '-')
arr.insert(17, '-')
arr.insert(21, '-')
